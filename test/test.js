...
var hasHasInstanceSymbol = ( typeof Symbol === 'function' && typeof Symbol.hasInstance === 'symbol' );
...
tape( 'if `Symbol.hasInstance` is supported, detection result is `true`', function test( t ) {
	if ( hasHasInstanceSymbol ) {
